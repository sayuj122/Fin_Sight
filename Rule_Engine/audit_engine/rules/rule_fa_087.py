...
RULE = build_rule(RuleSpec(
    rule_id='FA-087',
    name='Unstable trend: reserve growth',
    group='Financial Analytics Rules',
    category='financial_analytics',
    validation_logic='feature_volatility',
    severity=Severity.MEDIUM,
    required_metrics=('Reserve_Growth',),
    description='Tests unstable trend: reserve growth using only supplied financial-statement metrics.',
