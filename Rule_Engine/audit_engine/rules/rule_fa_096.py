...
RULE = build_rule(RuleSpec(
    rule_id='FA-096',
    name='Unstable trend: operating-cash-flow volatility',
    group='Financial Analytics Rules',
    category='financial_analytics',
    validation_logic='feature_volatility',
    severity=Severity.MEDIUM,
    required_metrics=('Operating_CF_Volatility',),
    description='Tests unstable trend: operating-cash-flow volatility using only supplied financial-statement metrics.',
