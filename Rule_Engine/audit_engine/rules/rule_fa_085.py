...
RULE = build_rule(RuleSpec(
    rule_id='FA-085',
    name='Unstable trend: borrowing growth',
    group='Financial Analytics Rules',
    category='financial_analytics',
    validation_logic='feature_volatility',
    severity=Severity.MEDIUM,
    required_metrics=('Borrowing_Growth',),
    description='Tests unstable trend: borrowing growth using only supplied financial-statement metrics.',
