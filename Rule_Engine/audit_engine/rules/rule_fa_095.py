...
RULE = build_rule(RuleSpec(
    rule_id='FA-095',
    name='Unstable trend: profit volatility',
    group='Financial Analytics Rules',
    category='financial_analytics',
    validation_logic='feature_volatility',
    severity=Severity.MEDIUM,
    required_metrics=('Profit_Volatility',),
    description='Tests unstable trend: profit volatility using only supplied financial-statement metrics.',
