...
RULE = build_rule(RuleSpec(
    rule_id='FA-093',
    name='Unstable trend: three-year profit CAGR',
    group='Financial Analytics Rules',
    category='financial_analytics',
    validation_logic='feature_volatility',
    severity=Severity.MEDIUM,
    required_metrics=('Profit_CAGR_3Y',),
    description='Tests unstable trend: three-year profit cagr using only supplied financial-statement metrics.',
