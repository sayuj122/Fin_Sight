...
RULE = build_rule(RuleSpec(
    rule_id='FA-104',
    name='Profit growth with cash decline',
    group='Financial Analytics Rules',
    category='financial_analytics',
    validation_logic='relationship_adverse',
    severity=Severity.HIGH,
    required_metrics=('Profit_Growth', 'Cash_Growth'),
    description='Tests profit growth with cash decline using only supplied financial-statement metrics.',
