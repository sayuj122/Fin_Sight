...
RULE = build_rule(RuleSpec(
    rule_id='RAT-019',
    name='Receivables turnover outlier',
    group='Handbook Rules',
    category='ratio',
    validation_logic='feature_zscore',
    severity=Severity.MEDIUM,
    required_metrics=('receivables_turnover',),
    description='Tests receivables turnover outlier using only supplied financial-statement metrics.',
