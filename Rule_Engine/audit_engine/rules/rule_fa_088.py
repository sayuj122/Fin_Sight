...
RULE = build_rule(RuleSpec(
    rule_id='FA-088',
    name='Unstable trend: operating-cash-flow growth',
    group='Financial Analytics Rules',
    category='financial_analytics',
    validation_logic='feature_volatility',
    severity=Severity.MEDIUM,
    required_metrics=('Operating_CF_Growth',),
    description='Tests unstable trend: operating-cash-flow growth using only supplied financial-statement metrics.',
