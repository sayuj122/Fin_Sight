...
RULE = build_rule(RuleSpec(
    rule_id='RAT-022',
    name='Days inventory outstanding trend',
    group='Handbook Rules',
    category='trend',
    validation_logic='increasing_trend',
    severity=Severity.MEDIUM,
    required_metrics=('dio',),
    description='Tests days inventory outstanding trend using only supplied financial-statement metrics.',
