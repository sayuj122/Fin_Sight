...
RULE = build_rule(RuleSpec(
    rule_id='FA-076',
    name='Unstable trend: receivable ratio',
    group='Financial Analytics Rules',
    category='financial_analytics',
    validation_logic='feature_volatility',
    severity=Severity.MEDIUM,
    required_metrics=('Receivable_Ratio',),
    description='Tests unstable trend: receivable ratio using only supplied financial-statement metrics.',
