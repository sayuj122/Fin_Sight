...
RULE = build_rule(RuleSpec(
    rule_id='FA-090',
    name='Unstable trend: inventory growth',
    group='Financial Analytics Rules',
    category='financial_analytics',
    validation_logic='feature_volatility',
    severity=Severity.MEDIUM,
    required_metrics=('Inventory_Growth',),
    description='Tests unstable trend: inventory growth using only supplied financial-statement metrics.',
