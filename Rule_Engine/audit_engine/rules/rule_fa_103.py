...
RULE = build_rule(RuleSpec(
    rule_id='FA-103',
    name='Revenue growth with operating-margin decline',
    group='Financial Analytics Rules',
    category='financial_analytics',
    validation_logic='relationship_adverse',
    severity=Severity.HIGH,
    required_metrics=('Revenue_Growth', 'Operating_Margin'),
    description='Tests revenue growth with operating-margin decline using only supplied financial-statement metrics.',
