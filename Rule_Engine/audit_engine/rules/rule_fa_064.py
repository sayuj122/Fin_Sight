...
RULE = build_rule(RuleSpec(
    rule_id='FA-064',
    name='Peer outlier: operating-cash-flow volatility',
    ...
    description='Tests peer outlier: operating-cash-flow volatility using only supplied financial-statement metrics.',
