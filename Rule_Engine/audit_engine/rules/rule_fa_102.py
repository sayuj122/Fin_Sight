...
RULE = build_rule(RuleSpec(
    rule_id='FA-102',
    name='Borrowing growth with flat revenue',
    group='Financial Analytics Rules',
    category='financial_analytics',
    validation_logic='relationship_adverse',
    severity=Severity.HIGH,
    required_metrics=('Borrowing_Growth', 'Revenue_Growth'),
    description='Tests borrowing growth with flat revenue using only supplied financial-statement metrics.',
