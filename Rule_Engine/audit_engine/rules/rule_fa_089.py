...
RULE = build_rule(RuleSpec(
    rule_id='FA-089',
    name='Unstable trend: receivable growth',
    group='Financial Analytics Rules',
    category='financial_analytics',
    validation_logic='feature_volatility',
    severity=Severity.MEDIUM,
    required_metrics=('Receivable_Growth',),
    description='Tests unstable trend: receivable growth using only supplied financial-statement metrics.',
