...
RULE = build_rule(RuleSpec(
    rule_id='FA-074',
    name='Unstable trend: working capital ratio',
    group='Financial Analytics Rules',
    category='financial_analytics',
    validation_logic='feature_volatility',
    severity=Severity.MEDIUM,
    required_metrics=('Working_Capital_Ratio',),
    description='Tests unstable trend: working capital ratio using only supplied financial-statement metrics.',
