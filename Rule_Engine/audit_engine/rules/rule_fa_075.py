...
RULE = build_rule(RuleSpec(
    rule_id='FA-075',
    name='Unstable trend: asset utilization',
    group='Financial Analytics Rules',
    category='financial_analytics',
    validation_logic='feature_volatility',
    severity=Severity.MEDIUM,
    required_metrics=('Asset_Utilization_Ratio',),
    description='Tests unstable trend: asset utilization using only supplied financial-statement metrics.',
