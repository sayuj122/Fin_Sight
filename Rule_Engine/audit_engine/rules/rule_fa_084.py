...
RULE = build_rule(RuleSpec(
    rule_id='FA-084',
    name='Unstable trend: profit growth',
    group='Financial Analytics Rules',
    category='financial_analytics',
    validation_logic='feature_volatility',
    severity=Severity.MEDIUM,
    required_metrics=('Profit_Growth',),
    description='Tests unstable trend: profit growth using only supplied financial-statement metrics.',
