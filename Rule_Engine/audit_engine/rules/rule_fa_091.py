...
RULE = build_rule(RuleSpec(
    rule_id='FA-091',
    name='Unstable trend: cash growth',
    group='Financial Analytics Rules',
    category='financial_analytics',
    validation_logic='feature_volatility',
    severity=Severity.MEDIUM,
    required_metrics=('Cash_Growth',),
    description='Tests unstable trend: cash growth using only supplied financial-statement metrics.',
