...
RULE = build_rule(RuleSpec(
    rule_id='FA-073',
    name='Unstable trend: borrowing dependency',
    group='Financial Analytics Rules',
    category='financial_analytics',
    validation_logic='feature_volatility',
    severity=Severity.MEDIUM,
    required_metrics=('Borrowing_Dependency_Ratio',),
    description='Tests unstable trend: borrowing dependency using only supplied financial-statement metrics.',
