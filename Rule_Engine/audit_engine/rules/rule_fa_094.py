...
RULE = build_rule(RuleSpec(
    rule_id='FA-094',
    name='Unstable trend: revenue volatility',
    group='Financial Analytics Rules',
    category='financial_analytics',
    validation_logic='feature_volatility',
    severity=Severity.MEDIUM,
    required_metrics=('Revenue_Volatility',),
    description='Tests unstable trend: revenue volatility using only supplied financial-statement metrics.',
