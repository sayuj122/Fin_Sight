...
RULE = build_rule(RuleSpec(
    rule_id='RAT-010',
    name='Gross profit margin trend',
    group='Handbook Rules',
    category='trend',
    validation_logic='declining_trend',
    severity=Severity.MEDIUM,
    required_metrics=('gross_margin',),
    description='Tests gross profit margin trend using only supplied financial-statement metrics.',
