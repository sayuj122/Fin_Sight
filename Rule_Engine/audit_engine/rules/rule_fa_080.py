...
RULE = build_rule(RuleSpec(
    rule_id='FA-080',
    name='Unstable trend: operating-cash-flow ratio',
    ...
    description='Tests unstable trend: operating-cash-flow ratio using only supplied financial-statement metrics.',
