...
RULE = build_rule(RuleSpec(
    rule_id='FA-105',
    name='Debt growth with interest-coverage decline',
    group='Financial Analytics Rules',
    category='financial_analytics',
    validation_logic='relationship_adverse',
    severity=Severity.HIGH,
    required_metrics=('Borrowing_Growth', 'Interest_Coverage_Ratio'),
    description='Tests debt growth with interest-coverage decline using only supplied financial-statement metrics.',
