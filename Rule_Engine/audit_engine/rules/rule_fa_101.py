...
RULE = build_rule(RuleSpec(
    rule_id='FA-101',
    name='Borrowing growth with cash decline',
    group='Financial Analytics Rules',
    category='financial_analytics',
    validation_logic='relationship_adverse',
    severity=Severity.HIGH,
    required_metrics=('Borrowing_Growth', 'Cash_Growth'),
    description='Tests borrowing growth with cash decline using only supplied financial-statement metrics.',
