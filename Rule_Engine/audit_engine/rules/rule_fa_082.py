...
RULE = build_rule(RuleSpec(
    rule_id='FA-082',
    name='Unstable trend: cash margin',
    group='Financial Analytics Rules',
    category='financial_analytics',
    validation_logic='feature_volatility',
    severity=Severity.MEDIUM,
    required_metrics=('Cash_Margin',),
    description='Tests unstable trend: cash margin using only supplied financial-statement metrics.',
